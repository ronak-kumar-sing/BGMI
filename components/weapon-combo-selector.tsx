...
export function WeaponComboSelector() {
  ...
  return (
    <div className="bg-zinc-800/50 border border-zinc-700/50 rounded-xl p-4 md:p-6 backdrop-blur-sm">
      {/* Filter Controls */}
      <div className="mb-8 space-y-6">
        <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="text-zinc-400 border-zinc-700 hover:bg-zinc-700/50"
            >
              Reset Filters
            </Button>
            ...
            <Button
              ...
              className={
                compareMode
                  ...
                  : "text-zinc-400 border-zinc-700 hover:bg-zinc-700/50"
              }
            >
              {compareMode ? "Exit Compare" : "Compare Combos"}
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <Label htmlFor="map-select" className="text-sm text-zinc-400 mb-2 block">
              Battle Map
            </Label>
            <Select value={selectedMap} onValueChange={setSelectedMap}>
              <SelectTrigger id="map-select" className="w-full bg-zinc-900/50 border-zinc-700">
          ...
          <div>
            <Label className="text-sm text-zinc-400 mb-2 block">Playstyle</Label>
            <RadioGroup value={selectedPlaystyle} onValueChange={setSelectedPlaystyle} className="flex gap-4">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="all" id="all" className="border-amber-500 text-amber-500" />
                <Label htmlFor="all" className="cursor-pointer">
                  All
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="aggressive" id="aggressive" className="border-amber-500 text-amber-500" />
                <Label htmlFor="aggressive" className="cursor-pointer">
                  Aggressive
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="tactical" id="tactical" className="border-amber-500 text-amber-500" />
                <Label htmlFor="tactical" className="cursor-pointer">
                  Tactical
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="sniper" id="sniper" className="border-amber-500 text-amber-500" />
                <Label htmlFor="sniper" className="cursor-pointer">
                  Sniper
                </Label>
              </div>
            </RadioGroup>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <Label htmlFor="range-slider" className="text-sm text-zinc-400">
                Engagement Range
              </Label>
              <TooltipProvider>
                <Tooltip>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-center">
                <Badge variant="outline" className="bg-zinc-900/50 text-amber-500 border-amber-500/30">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">
            Results <span className="text-sm text-zinc-400 ml-2">({filteredCombos.length} combos)</span>
          </h2>
        </div>
