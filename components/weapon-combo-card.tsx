    ...
    >
      <div className="p-4">
        <div className="flex justify-between items-start mb-3">
          ...
          {compareMode && (
            <Button
              ...
              className={isSelected ? "bg-amber-500 text-zinc-900 hover:bg-amber-600" : "border-zinc-700"}
            >
              {isSelected ? (
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <span className="text-sm text-zinc-400">Versatility</span>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-1">
            {combo.effectiveRanges.map((range) => (
              <Badge key={range} className="bg-amber-500/20 text-amber-500 border-amber-500/30 hover:bg-amber-500/30">
                {range}
              </Badge>
            ))}
          </div>
      ...
      {expanded && (
        <div className="px-4 pb-4 pt-1 border-t border-zinc-800 mt-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <h4 className="text-sm font-medium text-zinc-300 mb-2">Recoil Patterns</h4>
              <div className="bg-zinc-900/70 p-2 rounded border border-zinc-800 h-[120px] flex items-center justify-center">
          ...
          <div className="mt-4">
            <h4 className="text-sm font-medium text-zinc-300 mb-2">Range Performance</h4>
